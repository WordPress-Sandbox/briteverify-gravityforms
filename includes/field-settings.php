		...
		if( 400 === $position ){
			...
			<li class="bv_gf_enable_field_setting field_setting">
				...
				<div>
					...
					<input type="radio" name="bv_gf_enable" id="bv_gf_enable_default" size="10" value="default" />
					...
					<input type="radio" name="bv_gf_enable" id="bv_gf_enable_yes" size="10" value="yes" />
					<label for="bv_gf_enable_yes" class="inline">
						<?php esc_html_e( 'Enable', 'briteverify-gravityforms' ); ?>
					</label>
					&nbsp;&nbsp;

					<input type="radio" name="bv_gf_enable" id="bv_gf_enable_no" size="10" value="no" />
			...
			<li class="bv_gf_allow_disposable_field_setting field_setting">
				...
				<div>
					...
					<input type="radio" name="bv_gf_allow_disposable" id="bv_gf_allow_disposable_default" size="10" value="default" />
					<label for="bv_gf_enable_default" class="inline">
					...
					<input type="radio" name="bv_gf_allow_disposable" id="bv_gf_allow_disposable_yes" size="10" value="yes" />
					<label for="bv_gf_allow_disposable_yes" class="inline">
						<?php esc_html_e( 'Allow', 'briteverify-gravityforms' ); ?>
					</label>
					&nbsp;&nbsp;

					<input type="radio" name="bv_gf_allow_disposable" id="bv_gf_allow_disposable_no" size="10" value="no" />
